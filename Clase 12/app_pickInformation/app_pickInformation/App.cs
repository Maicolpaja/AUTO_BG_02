...
namespace app_pickInformation
{
    class App : IExternalApplication
    {
        ...
        private void createAddButton(RibbonPanel panel)
        {
            ...
            //BUTTON 04
            PushButtonData pbd_04 = new PushButtonData("Button 04", "Button 04 text", assemblyPath, "app_pickInformation.cmd_ExportElementInformation");
            pbd_04.LongDescription = "Este es un button para probar una external application";


            PushButton pb_04 = panel.AddItem(pbd_04) as PushButton;
            SetIconsForPushButton(pb_04, Properties.Resources.exportElementInformation);

            //BUTTON 05
            PushButtonData pbd_05 = new PushButtonData("Button 05", "Button 05 text", assemblyPath, "app_pickInformation.cmd_ImportElementInformation");
            pbd_05.LongDescription = "Este es un button para probar una external application";


            PushButton pb_05 = panel.AddItem(pbd_05) as PushButton;
            SetIconsForPushButton(pb_05, Properties.Resources.importElementInformation);
        }
